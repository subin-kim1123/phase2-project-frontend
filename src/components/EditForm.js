        ...
        return (
            <div>
                ...
                <Form onSubmit={this.handleSubmit}>
                    ...
                    <Form.Group widths="equal">
                    <Form.Input label="readyIn" placeholder={readyIn} name="readyIn" onChange={this.handleChange} value={this.state.readyIn} />
                    </Form.Group>
                    
                    <Form.Group widths="equal">
                    <Form.Input label="servings" placeholder={servings} name="servings" onChange={this.handleChange} value={this.state.servings} />
                    </Form.Group>

                    <Form.Group widths="equal">
                    <Form.Input label="calories" placeholder={calories} name="calories" onChange={this.handleChange} value={this.state.calories} />
                    </Form.Group>

                    <Form.Group widths="equal">
                    <Form.Input label="ingredients" placeholder={[ingredients]} name="ingredients" onChange={this.handleChange} value={this.state.ingredients} />
                    </Form.Group>
                    
                    <Form.Group widths="equal">
                    <Form.Input label="steps" placeholder={[steps]} name="steps" onChange={this.handleChange} value={this.state.steps} />
                    </Form.Group>
                    
                    <Form.Group widths="equal">
                    <Form.Input label="image" placeholder={image} name="image" onChange={this.handleChange} value={this.state.image} />
                    </Form.Group>

                    <Form.Group widths="equal">
                    <Form.Input label="blog" placeholder={blog} name="blog" onChange={this.handleChange} value={this.state.blog} />
                    </Form.Group>

                    <Form.Group widths="equal">
                    <Form.Input label="winePairing" placeholder={winePairing} name="winePairing" onChange={this.handleChange} value={this.state.winePairing} />
                    </Form.Group>
